package com.bappul.delivery.pomotion.application.validator;

import static com.bappul.delivery.pomotion.exception.ServiceExceptionCode.ALREADY_ISSUED_COUPON;
import static com.bappul.delivery.pomotion.exception.ServiceExceptionCode.ALREADY_USED_COUPON;
import static com.bappul.delivery.pomotion.exception.ServiceExceptionCode.EXCEEDED_COUPON_ISSUE_LIMIT;
import static com.bappul.delivery.pomotion.exception.ServiceExceptionCode.INVALID_COUPON_CODE;
import static com.bappul.delivery.pomotion.exception.ServiceExceptionCode.NOT_FOUND_COUPON;
import static com.bappul.delivery.pomotion.exception.ServiceExceptionCode.NOT_FOUND_COUPON_POLICY;
import static com.bappul.delivery.pomotion.exception.ServiceExceptionCode.POLICY_INACTIVE;
...
import com.bappul.delivery.pomotion.domain.repository.CouponPolicyRepository;
