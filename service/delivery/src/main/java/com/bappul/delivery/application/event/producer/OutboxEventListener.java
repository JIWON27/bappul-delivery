package com.bappul.delivery.application.event.producer;

import static com.bappul.delivery.exception.ServiceExceptionCode.NOT_FOUND_OUTBOX_EVENT;
...
public class OutboxEventListener {
  ...
  public void handleEvent(OutboxRecorded event) {
    log.info("[delivery - OutboxEventListener] 커밋 이벤트 수신");
